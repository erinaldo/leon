...
namespace OFC
{
    public partial class frmNotaDeCreditoArticulo : Form
    {
        ...
        public frmNotaDeCreditoArticulo()
        {
            ...
            _ncDetalle = new List<NotaDeCreditoCompDetalleDTO>();
            _impuestoDetalle = new List<ImpuestoDetalleDTO>();
            _ivaDetalle = new List<IvaComprasDetalleDTO>();
            _ncDeArticulos = new NotaDeCreditoDeCompra();
        ...
        private void frmNotaDeCreditoArticulo_Load(object sender, EventArgs e)
        {
        ...
        {
            this.dgvDetalleNCCompra.AutoGenerateColumns = false;
            ...
            _precio_unitario.HeaderText = "P. Unit.";
            _precio_unitario.Width = 80;
            ...
            this.dgvDetalleNCCompra.Columns.Add(_cantidad);
            this.dgvDetalleNCCompra.Columns.Add(_unidad); //xx2
            this.dgvDetalleNCCompra.Columns.Add(_codigo);
            this.dgvDetalleNCCompra.Columns.Add(_descripcion);
            this.dgvDetalleNCCompra.Columns.Add(_precio_unitario);
            this.dgvDetalleNCCompra.Columns.Add(_importe);
        ...
        private void clearForm()
        {
            ...
            txtNroNotaDeCreditoCompra.Text = string.Empty;
            ...
            txtPrecioUnitario.Text = string.Empty;
            txtImporte.Text = string.Empty;
            dgvDetalleNCCompra.DataSource = null;
        ...
        private bool validarNulidadDatos(ref string msg)
        {
            ...
            if (this.txtNroNotaDeCreditoCompra.Text == "")
            {
                rv = false;
                msg += "\nDebe ingresar el número de nota de crédito.";
            }

            if (this.dgvDetalleNCCompra.RowCount == 0)
            {
                rv = false;
                msg += "\nDebe ingresar el detalle de la nota de crédito.";
            }
        ...
        private NotaDeCreditoDeCompraDTO formToObject()
        {
            NotaDeCreditoDeCompraDTO data = new NotaDeCreditoDeCompraDTO();

            data.Id_proveedor = cbxCodProveedor.Text;
            data.Nombre_proveedor = cbxNombreDelProveedor.Text;
            data.Es_concepto = 'N';
            data.Cod_comprobante = txtNroNotaDeCreditoCompra.Text;
            data.Tipo_nota_credito = char.Parse(cbxTipoFactura.Text);
        ...
        {
            NotaDeCreditoCompDetalleDTO det = new NotaDeCreditoCompDetalleDTO();
            ...
            _ncDetalle.Add(det);
            this.dgvDetalleNCCompra.DataSource = null;
            this.dgvDetalleNCCompra.DataSource = _ncDetalle;
            this.dgvDetalleNCCompra.ClearSelection();
        ...
        private void btnAgregarItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else //xx
                {
                    ...
                    {
                        MessageBox.Show("El comprobante no existe para el proveedor seleccionado", "Nota de Crédito de Compra");
                    }
                }
            }
            catch (Exception ex)
        ...
        {
            DialogResult dialogResult2 = MessageBox.Show("¿Desea registrar la nota de crédito de compra?", "Nota de Crédito de Compra", MessageBoxButtons.YesNo);
            if (dialogResult2 == DialogResult.Yes)
            {
                ...
                {
                    NotaDeCreditoDeCompraDTO data = this.formToObject();
                    _ncDeArticulos.registrar(data, _ncDetalle, _ivaDetalle, _impuestoDetalle, _comprobanteRelacion); //xx
                    clearForm();
                    MessageBox.Show("La operación fue realizada con éxito.", "Nota de Crédito de Compra");
                }
                else
                {
                    MessageBox.Show("No ha sido posible registrar la nota de crédito de compra. Corrija los siguientes errores y vuelva a intentarlo: \n" + msg, "Nota de Crédito de Compra");
                }
            }
        }
        ...
        private void btnQuitarItem_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.dgvDetalleNCCompra.SelectedRows.Count > 0)
                {
                    NotaDeCreditoCompDetalleDTO regSel = (NotaDeCreditoCompDetalleDTO)this.dgvDetalleNCCompra.SelectedRows[0].DataBoundItem;
                    if (regSel.Exento == 'N')
                    {
