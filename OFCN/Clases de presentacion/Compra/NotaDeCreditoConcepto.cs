...
namespace OFC
{
    public partial class frmNotaDeCreditoConcepto : Form
    {
        ...
        NotaDeCreditoDeCompra _ncDeConceptos;
        List<ComprobanteRelacionDTO> _comprobanteRelacion;
        
        public frmNotaDeCreditoConcepto()
        {
            InitializeComponent();
            ...
            _ncDeConceptos = new NotaDeCreditoDeCompra();
            _comprobanteRelacion = new List<ComprobanteRelacionDTO>();
        }

        private void frmNotaDeCreditoConcepto_Load(object sender, EventArgs e)
        {
        ...
        private void btnAgregarItem_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(ex.Message + ' ' + inner, "Validación agregar item a la nota de crédito");
            }
        ...
        private void calcularIva()
        {
            if (cbxPorcentajeDeIva.Text != string.Empty)
            {
                ...
                {
                    //neto = decimal.Parse(txtNeto.Text);
                    neto = _conceptos.sumarSegunIva(_ncDetalle, decimal.Parse(cbxPorcentajeDeIva.Text)); //feb 
                }
        ...
        private void btnRegistrar_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult2 == DialogResult.Yes)
            {
                ...
                if (validarNulidadDatos(ref msg))
                {
                    ...
                    _ncDeConceptos.registrar(data, _ncDetalle, _ivaDetalle, _impuestoDetalle, _comprobanteRelacion);
                    clearForm();
