...
namespace OFC
{
    class GenerarImpresionFacturaB
    {
        public static crFacturaB cargarReporte(string tipoComprobante, long idOrigen, string cod_comprobante_remito)
        {
            ...
            crFacturaB rptLista = new crFacturaB();
        ...
        public static crFacturaB cargarReporte105(string tipoComprobante, long idOrigen, string cod_comprobante_remito)
        {
            NpgsqlConnection cn = BaseDeDatos.obtenerConexion();
            NpgsqlCommand cmComando = new NpgsqlCommand();
            dsFacturaA dsLista = new dsFacturaA();
        ...
        public static crFacturaB cargarReporteCredito(long idOrigen)
        {
            NpgsqlConnection cn = BaseDeDatos.obtenerConexion();
            NpgsqlCommand cmComando = new NpgsqlCommand();
            dsFacturaA dsLista = new dsFacturaA();
        ...
        public static crFacturaB cargarReporteDebito(long idOrigen)
        {
            NpgsqlConnection cn = BaseDeDatos.obtenerConexion();
            NpgsqlCommand cmComando = new NpgsqlCommand();
            dsFacturaA dsLista = new dsFacturaA();
