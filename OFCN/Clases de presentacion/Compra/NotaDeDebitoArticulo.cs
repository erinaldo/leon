...
namespace OFC
{
    public partial class frmNotaDeDebitoArticulo : Form
    {
        ...
        public frmNotaDeDebitoArticulo()
        {
            ...
            _ndDeArticulos = new NotaDeDebitoDeCompra();
        ...
        private void frmNotaDeDebitoArticulo_Load(object sender, EventArgs e)
        {
        ...
        private void configurarGridDetalleDebito()
        {
            ...
            this.dgvDetalleNDCompra.Columns.Add(_cantidad);
            this.dgvDetalleNDCompra.Columns.Add(_unidad); //xx2
            this.dgvDetalleNDCompra.Columns.Add(_codigo);
            this.dgvDetalleNDCompra.Columns.Add(_descripcion);
            this.dgvDetalleNDCompra.Columns.Add(_precio_unitario);
        ...
        private void clearForm()
        {
            ...
            txtNroNotaDeDebitoCompra.Text = string.Empty;
        ...
        private bool validarNulidadDatos(ref string msg)
        {
            ...
            if (this.txtNroNotaDeDebitoCompra.Text == "")
            {
                rv = false;
        ...
        private NotaDeDebitoDeCompraDTO formToObject()
        {
            ...
            data.Es_concepto = 'N';
            data.Cod_comprobante = txtNroNotaDeDebitoCompra.Text;
        ...
        private void btnRegistrar_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult2 == DialogResult.Yes)
            {
                ...
                if (validarNulidadDatos(ref msg))
                {
                    ...
                    _ndDeArticulos.registrar(data, _ndDetalle, _ivaDetalle, _impuestoDetalle, _comprobanteRelacion); //xx
                    clearForm();
